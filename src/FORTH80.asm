...
EXPEC1	DW	KEY
	...
	DW	ZBRAN,EXPEC2-$	;  IF
	DW	DROP
	; ADDITIONAL PART (for UTF-8 multi-byte)
	DW	UTF8
	DW	ATT
	DW	ZBRAN,EXPE10-$	;   IF
	DW	DUPE
...
EXPEC8	DW	IDO
	DW	ONEM
	DW	CAT
	DW	LIT,0C0H	;      ( = 0b11000000 )
	DW	ANDD
	DW	LIT,80H		;      ( = 0b10000000 )
	DW	EQUAL
	DW	ZBRAN,EXPEC9-$	;     WHILE
	DW	FROMR
	DW	ONEM
	DW	TOR
	DW	DROP
	DW	ONE
	DW	BRAN,EXPEC8-$	;     REPEAT
EXPEC9	DW	ZBRAN,EXPE10-$	;     IF
	DW	LIT,8H
	DW	EMIT
	DW	BLS
	DW	EMIT
